...
from doclayout_yolo.utils.loss import (
...
class DetectionModel(BaseModel):
    ...
    def __init__(
        ...
        if isinstance(
            ...
            if isinstance(m, v10Detect) or isinstance(m, v10DetectWithEL):
...
class YOLOv10WithELDetectionModel(DetectionModel):
    def init_criterion(self):
        return v10DetectWithELLoss(self)
...
def guess_model_task(model):
    ...
    def cfg2task(cfg):
        ...
        if m in {"classify", "classifier", "cls", "fc"}:
            return "classify"
        if m == "detect" or m == "v10detect" or m == "v10detectwithel":
            return "detect"
        if m == "segment":
            return "segment"
        if m == "pose":
    ...
    if isinstance(model, nn.Module):  # PyTorch model
        ...
        for m in model.modules():
            if isinstance(m, Segment):
                ...
                return "obb"
            elif isinstance(m, (Detect, WorldDetect, v10Detect, v10DetectWithEL)):
                return "detect"
