...
parser.add_argument(
    ...
    help="JSON file",
    dest="json",
    default="/home/azureuser/cloudfiles/code/datasets/odel_title_value/train.json",
)
parser.add_argument(
    "-o",
    help="path to output folder",
    dest="out",
    default="/home/azureuser/cloudfiles/code/datasets/odel_title_value_yolo",
)
...
class COCO2YOLO:
    ...
    def _convert_anno(self, images_info):
        ...
        for anno in self.labels["annotations"]:
            ...
            if yolo_box[0] >= 1 or yolo_box[1] >= 1:
                continue
